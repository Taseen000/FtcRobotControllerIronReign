...
import org.firstinspires.ftc.teamcode.robots.goldenduck.util.TelemetryProvider;
...
public abstract class VisionProvider implements TelemetryProvider {
    ...
    private List<org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position> positions;
    private org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position mostFrequentPosition;
    ...
    public VisionProvider() {
        mostFrequentPosition = org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position.HOLD;
    ...
    public org.firstinspires.ftc.teamcode.robots.goldenduck.vision.VisionProvider setRedAlliance(boolean isRedAlliance) {
        this.isRedAlliance = isRedAlliance;
        return this;
    }
    ...
    abstract public org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position getPosition();
    ...
    private void updateMostFrequentPosition() {
        ...
        if(leftCount >= middleCount && leftCount >= rightCount)
            mostFrequentPosition = org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position.LEFT;
        else if(middleCount >= leftCount && middleCount >= rightCount)
            mostFrequentPosition = org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position.MIDDLE;
        else
            mostFrequentPosition = org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position.RIGHT;
    ...
    public void update() {
        ...
        org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position position = getPosition();
        if(position != org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position.HOLD && position != org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Position.NONE_FOUND)
        {
