package org.firstinspires.ftc.teamcode.robots.goldenduck.vision.provider;
...
import org.firstinspires.ftc.teamcode.robots.goldenduck.vision.pipeline.GDPropDetectorPipeline;
...
@Config  (value = "GD_PropDetectorProvider")
public class GDPropDetectorProvider extends VisionProvider {
    private Bitmap noCameraBitmap;
    private OpenCvCamera camera;
    private GDPropDetectorPipeline pipeline;
    ...
    public void initializeVision(HardwareMap hardwareMap) {
        pipeline = new GDPropDetectorPipeline(isRedAlliance);
