package org.firstinspires.ftc.teamcode.robots.goldenduck.vision.pipeline;
...
import org.firstinspires.ftc.teamcode.robots.goldenduck.vision.Target;
...
public class GDPropDetectorPipeline extends TimestampedOpenCvPipeline {
    ...
    public static double RED_ALLIANCE_HUE_MIN = 80, RED_ALLIANCE_HUE_MAX = 120;
...
//    public static double BLUE_ALLIANCE_VALUE_MIN = 80, BLUE_ALLIANCE_VALUE_MAX = 180;
    ...
    public GDPropDetectorPipeline() {
        largestX = -1;
        largestY = -1;
        largestArea = -1;
        lastPosition = Position.HOLD;
    }
    public GDPropDetectorPipeline(boolean isRedAlliance) {
    ...
    public Mat processFrame(Mat input, long timestamp) {
        ...
        org.firstinspires.ftc.teamcode.robots.goldenduck.vision.pipeline.GDPropDetectorPipeline.BlurType blurType = org.firstinspires.ftc.teamcode.robots.goldenduck.vision.pipeline.GDPropDetectorPipeline.BlurType.get(BLUR);
    ...
    enum BlurType {
        ...
        public static org.firstinspires.ftc.teamcode.robots.goldenduck.vision.pipeline.GDPropDetectorPipeline.BlurType get(String type) {
    ...
    private void blur(Mat input, org.firstinspires.ftc.teamcode.robots.goldenduck.vision.pipeline.GDPropDetectorPipeline.BlurType type, double doubleRadius,
                      Mat output) {
